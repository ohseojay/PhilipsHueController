...
b = Bridge('172.30.1.39') #Change this to your bridge's ip. (findable in windows file explorer network section)
selected = "lightstrip"

window=Tk()
window.title("Jay's Bedroom Lighting System Controller") #Change this to the name you want.
window.geometry("320x320")
window.resizable(width=False, height=False)

bri = 0

#All the Lightstrips and bedrooms are configured for my philips hue setup, you must change it to yours. The selected == thing is a variable, it is in the last section of function.
#You can change that to any name you want.
def LightStripOn():
